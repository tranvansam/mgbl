<template>
  <!-- Stats -->
  <div id="gioithieu" class="stats">
    <div class="content">
      <div class="row">
        <div class="img-block">
          <img
            class="image"
            src="~/assets/img/profile-baolam.jpeg"
          ...
          <div class="stats-trend">
            <div class="row">
              <strong class="value">500+</strong>
              <img src="~/assets/img/arrow-trend-up.svg" alt="" class="icon" />
            </div>
            <p class="desc">
              Hơn 500 show diễn hằng năm . Luôn là sự lựa chọn hàng đầu của
              khách hàng
            </p>
        ...
        <div class="info">
          <h2 class="sub-title">Dịch vụ của Bảo Lam cam kết</h2>
          <p class="desc">
      ...
      <div class="row row-qty">
        <div class="qty-item">
          <strong class="qty">1 triệu</strong>
          <p class="qty-desc">Lượt theo dõi </p>
        </div>
        <div class="qty-item">
          <strong class="qty">5,000+</strong>
          <p class="qty-desc">Show diễn</p>
        </div>
        <div class="qty-item">
          <strong class="qty">100%</strong>
          <p class="qty-desc">Sự hài lòng</p>
        </div>
      </div>
    </div>
  </div>
